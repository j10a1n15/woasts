...
// use this folder to store autogenerated files
val generatedDir = "build/generated/${rootProject.name}"

sourceSets {
	// sources autogenerated resources
	main {
		resources {
			srcDirs(rootProject.file("$generatedDir/resources"))
		}
	}
}
...
tasks.register<FlattenLangTask>("flattenLang") {
	...
	val output = rootProject.file("$generatedDir/resources/assets/${rootProject.name}/lang")
